  ...
  <div class="user_options-container">
    <div class="user_options-text">
      <div class="user_options-unregistered div-logo">
        <div class="logo-sma">
          <img src="<?=base_url('assets/img/lsma.png');?>" style="width: 100px; margin-right: 30px;">
          <h1>SMA MUHAMMADIYAH KUDUS</h1>
        </div>
        <!-- <h2 class="user_unregistered-title">SMA MUHAMMADIYAH KUDUS</h2> -->
